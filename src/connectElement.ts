...
export const connectElement = (
  liveState: LiveState,
  el: HTMLElement,
  { properties, attributes, events }: ConnectOptions
) => {
...
const connectProperties = (liveState, el, properties) => {
  ...
  mergedProperties = el._liveStateProperties
    ? mergedProperties.concat(el._liveStateProperties)
    : mergedProperties;
...
export const connectProperty = (
  liveState: LiveState,
  el: HTMLElement,
  property: LiveStateProperty
) => {
  liveState.addEventListener(
    "livestate-change",
    buildPropertyListener(el, property)
  );
};
 ...
 */
export const connectAtttribute = (
  liveState: LiveState,
  el: HTMLElement,
  attr: string
) => {
